...
async def analyze_document_async(file_path, document_client):
    """Asynchronous call to analyze a document and return markdown content."""
    try:
...
async def process_all_documents_async(input_dir, markdown_dataframe, backup_dir=None):
    ...
    # Initialize async Azure Document Intelligence client
    ...
    async def handle_file(file_name):
        ...
        if markdown_content:
            ...
            if backup_dir:
                ...
                with open(backup_path, "w", encoding="utf-8") as md_file:
